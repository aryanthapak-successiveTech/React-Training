...
const WelcomeAndTheme = () => {
  ...
  return (
    <div className="form">
      ...
      />
      {!isUserNameValid && (
        <p className="wrongInput">Enter a valid username without spaces</p>
      )}
      <Input
        title="Password"
        type="password"
      ...
      />
      {!isPasswordValid && (
        <p className="wrongInput">Enter password of length 8 words or more</p>
      )}
...
export default WelcomeAndTheme;
